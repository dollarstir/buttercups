...
<head>
	...
	<title>ButterCups - Activities</title>
...
<body>
	...
	<div class="slider">
		...
		<?php Slideactivities();?>
			<!-- <li data-thumb="images/uploads/slider4.jpg"> 
	...
	<div id="template-styles">
		<h2>Template Styles <a href="hotels.html#"><img class="s-s-icon" src="images/settings.png" alt="Style switcher" /></a></h2>
		<div>
		<h3>Colors</h3>
			<ul class="colors" >
				<li><a href="hotels.html#" class="yellow" title="yellow"></a></li>
				<li><a href="hotels.html#" class="orange" title="orange"></a></li>
				<li><a href="hotels.html#" class="strawberry" title="strawberry"></a></li>
				<li><a href="hotels.html#" class="pink" title="pink"></a></li>
				<li><a href="hotels.html#" class="purple" title="purple"></a></li>
				<li><a href="hotels.html#" class="blue" title="blue"></a></li>
				<li><a href="hotels.html#" class="turqoise" title="turqoise"></a></li>
				<li><a href="hotels.html#" class="black" title="black"></a></li>
			</ul>
		</div>
	</div>
