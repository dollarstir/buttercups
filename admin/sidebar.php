...
<div class="main-menu-content">
  <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="">
    ...
    <li class=" nav-item"><a href="form-layout.html#"><i class="bx bx-check"></i><span class="menu-title" data-i18n="Form Elements"> Activities</span></a>
      <ul class="menu-content">
        <li><a href="add-activities.php"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Input">Add activities</span></a>
        </li>
        <li><a href="view-activities.php"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Input Groups">View activities</span></a>
        </li>
    ...
    <li class=" nav-item"><a href="form-layout.html#"><i class="bx bx-map"></i><span class="menu-title" data-i18n="Miscellaneous">Locations</span></a>
      <ul class="menu-content">
        ...
        <li><a href="view-location.php"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Not Authorized">View Locations</span></a>
        </li>
