...
<head>
	...
	<title>Buttercups Tour - Home</title>
					...
					<div class="offers">
						<div class="row">
							...
							<article class="one-fourth">
								<figure><a href="index.html#" title=""><img src="images/uploads/img1.jpg" alt="" /></a></figure>
								<div class="details">
									<h3>Winter beach escapes 30% off</h3>
									<a href="index.html#" title="Explore our deals" class="gradient-button">Explore our deals</a>
								</div>
							</article>
							<!--//column-->
							...
							<!--column-->
							<article class="one-fourth">
								<figure><a href="index.html#" title=""><img src="images/uploads/paris.jpg" alt="" /></a></figure>
								<div class="details">
									<h3>Spend New Year‘s Eve in Paris</h3>
									<a href="index.html#" title="More info" class="gradient-button">More info</a>
								</div>
							</article>
							<!--//column-->
							...
							<!--column-->
							<article class="one-fourth">
								<figure><a href="index.html#" title=""><img src="images/uploads/img2.jpg" alt="" /></a></figure>
								<div class="details">
							...
							<!--column-->
							<article class="one-fourth">
								<figure><a href="index.html#" title=""><img src="images/uploads/thailand.jpg" alt="" /></a></figure>
								<div class="details">
